<?php if (!empty($carrusel) && $mostrarHero): ?>
...
<div class="netflix-container" style="padding-bottom: 50px;">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        $('.slick-row').slick({
            ...
            infinite: true,
            speed: 500,
            slidesToShow: 6, // Muestra 6 pelis a la vez
            slidesToScroll: 3, // Avanza de 3 en 3 al dar a la flecha
            responsive: [
